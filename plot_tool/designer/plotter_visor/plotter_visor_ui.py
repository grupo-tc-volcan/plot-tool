...
class Ui_GraphPlotterVisor(object):
    def setupUi(self, GraphPlotterVisor):
        ...
        GraphPlotterVisor.resize(300, 510)
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 282, 258))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 282, 258))
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 282, 258))
